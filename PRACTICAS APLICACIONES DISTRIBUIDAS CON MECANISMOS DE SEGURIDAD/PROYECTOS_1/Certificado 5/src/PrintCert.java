	...
	public static void main(String args[]) {
			...
			try {
				...
				for(int i=0;i<4;i++){
					...
					FileInputStream fr5 = new FileInputStream("CACertificado.pem");
					System.out.print("Introducir Nombre Certificado CA(*.pem): " );
					String NameFile3=teclado.readLine();
					System.out.println("Leido nombre fichero CA:"+NameFile3 );
					
					CertificateFactory cf5 = CertificateFactory.getInstance("X509");
					X509Certificate c5 = (X509Certificate) cf5.generateCertificate(fr5);
	
					PublicKey publiKeyCA=c5.getPublicKey();
	

					c4.verify(publiKeyCA);
